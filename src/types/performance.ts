...
export const DEFAULT_PARAMETERS: ParameterDefinition[] = [
  {
    id: 'timbre',
    name: 'Timbre',
    category: ParameterCategory.TEXTURE,
    description: 'Spectral brightness / harmonic content',
    min: 0,
    max: 1,
    defaultValue: 0.5,
  ...
  },
  {
    ...
    description: 'Spatial depth / resonance',
    min: 0,
    max: 1,
    defaultValue: 0.3,
    audienceControllable: true,
